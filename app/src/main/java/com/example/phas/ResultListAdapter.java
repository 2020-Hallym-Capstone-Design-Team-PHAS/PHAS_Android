...
public class ResultListAdapter extends BaseAdapter {
    ...
    private ArrayList<ResultItemData> listViewItemList = new ArrayList<ResultItemData>();

    // ListViewAdapter의 생성자
    public ResultListAdapter(ArrayList<ResultItemData> data) { }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView descTextView = (TextView) convertView.findViewById(R.id.date);

        // Data Set(listViewItemList)에서 position에 위치한 데이터 참조 획득
        ResultItemData listViewItem = listViewItemList.get(position);
